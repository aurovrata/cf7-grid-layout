<?php
/**
 * PHP hooks helpers for hooks fired prior to the form loading.
...
return $html;
}" href="javascript:void(0);"><?php esc_html_e( 'Filter', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'cf7 tag field pre-html.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
function filter_post_html($html, $cf7_key){
	...
	return $html;
}" href="javascript:void(0);"><?php esc_html_e( 'Filter', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'cf7 tag field post-html.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
function filter_required_html($html, $cf7_key){
	...
	return $html;
}" href="javascript:void(0);"><?php esc_html_e( 'Filter', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'cf7 tag required-html.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
function form_wrapper_id($css_id, $cf7_key){
	...
	return $css_id;
}" href="javascript:void(0);"><?php esc_html_e( 'Filter', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'the form wrapper css id.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
}" href="javascript:void(0);"><?php esc_html_e( 'Insert', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'hidden fields.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
}" href="javascript:void(0);"><?php esc_html_e( 'Prefill', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'form fields.', 'cf7-grid-layout' ); ?>
</li>
<li>
...
}" href="javascript:void(0);"><?php esc_html_e( 'Localize', 'cf7-grid-layout' ); ?></a> <?php esc_html_e( 'custom js script.', 'cf7-grid-layout' ); ?>
</li>
