...
class Cf7_Grid_Layout {
	...
	private function define_admin_hooks() {
		...
		/** NB @since 1.5.0 hack to enqueue js/css for other cf7 extensions.*/
		...
		/** NB persist admin notices plugin. @since 4.1.0 */
	...
	private function define_public_hooks() {
		...
		*@since 1.1.0  */
		...
		/** NB @since 4.11.0 enable custom submission messages using HTML.*/
