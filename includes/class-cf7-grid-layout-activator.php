...
class Cf7_Grid_Layout_Activator {
	...
	public static function activate() {
        ...
        you will need to activate the Smart Grid-layout plugin on those sites only',
						'cf7-grid-alyout'
					)
				);
			}
			exit( esc_html__( 'This plugin requires the Contact Form 7 plugin to be activated first', 'cf7-grid-layout' ) );
		}
	}
